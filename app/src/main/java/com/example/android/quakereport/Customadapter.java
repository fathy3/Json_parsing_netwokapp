...
public class Customadapter extends ArrayAdapter<earthquakcustomclass> {
    ...
    public Customadapter(Context context, ArrayList<earthquakcustomclass> earthquakcustomclasses) {
        super(context, 0, earthquakcustomclasses);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        earthquakcustomclass currentEarthquake = getItem(position);
